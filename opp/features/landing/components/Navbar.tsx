        ...
        <div className="max-w-[1400px] mx-auto h-16 flex items-center justify-between px-4 md:px-6">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <nav className="hidden md:flex items-center gap-3 text-[15px] text-gray-700">
              ...
              <button className="flex items-center gap-1 px-3 py-2 rounded-md hover:bg-gray-200">
                Donate <ChevronDown size={16} />
              </button>
              ...
              <div
                ...
                onMouseLeave={() => setCommunityOpen(false)}
              >
                <button className="flex items-center gap-1 px-3 py-2 rounded-md bg-gray-200">
                  Community <ChevronDown size={16} />
                </button>

                {communityOpen && (
                  <div className="absolute top-full mt-2 w-64 bg-white rounded-xl shadow-lg p-3 space-y-2">
                    {[
                      "Get Started",
                      "Givers NFT",
                      "About Us",
              ...
              <button
                onClick={() => setSearchOpen(true)}
                className="flex items-center gap-2 px-4 py-2 rounded-md bg-gray-200"
              >
                Search <Search size={16} />
              </button>
            </nav>
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            {isLoggedIn && (
              <>
                {/* CREATE */}
                <button className="hidden sm:flex items-center gap-2 bg-pink-500 text-white px-4 py-2 rounded-md text-sm">
                  <Plus size={16} /> Create
                </button>

                {/* MOBILE CREATE (ICON ONLY) */}
                <button className="sm:hidden p-2 rounded-full bg-pink-500 text-white">
                  <Plus size={18} />
                </button>
                ...
                {/* PROFILE */}
                <div className="relative group">
                  <div className="flex items-center gap-2 bg-gray-200 px-2 py-1.5 rounded-full cursor-pointer">
                    {avatarUrl ? (
                      <img src={avatarUrl} className="h-8 w-8 rounded-full" />
                    ) : (
                      <div className="h-8 w-8 rounded-full bg-black text-white flex items-center justify-center">
                  ...
                  {/* DROPDOWN */}
                  <div className="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition">
                    <button className="w-full text-left px-4 py-3 hover:bg-gray-100 flex gap-2">
                      <Settings size={16} /> Settings
                    </button>
                    <button
